...
with tab1:
    ...
    fourWeekIncome = st.number_input("On average how much do you make in 30 days")
    millRateIncome = mill_rate(fourWeekIncome,30)
    ...
    st.metric(":green[Projected savings 💵]", millRateAdjusted*60*60*24*30/1000)
